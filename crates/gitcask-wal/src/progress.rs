//! Progress packets for long-running repository work (pack downloads,
//! compaction, ...). This is the wire standard of
//! the SSE envelope (`AGENTS.md` §2.6): the SSE `event:` name is
